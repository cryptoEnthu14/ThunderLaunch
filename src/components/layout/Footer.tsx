 ...
 * Footer Component
 *
 * Application footer with links, social media, copyright notice,
...
const socialLinks: SocialLink[] = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/thunderlaunch',
    icon: (
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/thunderlaunch',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/thunderlaunch',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
...
const stats: Stat[] = [
  { label: 'Tokens Launched', value: '10K+' },
 ...
 * Footer Component
 *
 * Application footer with comprehensive links and information
 */
  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 mt-auto">
      ...
      <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-b border-gray-800">
        <Container>
          <div className="py-8 grid grid-cols-3 gap-4 md:gap-8">
            {stats.map((stat) => (
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                © {currentYear} ThunderLaunch. All rights reserved.
              </p>
            </div>
          </div>
